...
const NGORegister = () => {
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-orange-100 to-green-100 px-4">
      <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-lg border border-orange-100">
        ...
        <p className="text-center text-sm text-gray-600 mb-6">
          Create your NGO account to start receiving food donations.
        </p>
        ...
        <p className="mt-4 text-center text-sm text-gray-600">
          ...
          <a href="/ngo-login" className="text-amber-500 hover:underline">
            Login here
          </a>
        </p>
      </div>
